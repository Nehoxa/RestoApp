            ...
            <div class="p-2 bg-slate-100 rounded">
                ...
                <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                    <form method="POST" action="{{ route('admin.reservations.store') }}">
                        ...
                        <div class="sm:col-span-6 pt-3">
                            <label for="table_id" class="block text-sm font-medium text-gray-700">Table</label></label>
                            <div class="mt-1">
                        ...
                        <div class="pt-5">
                            <button type="submit"
                                class="px-4 py-2 bg-blue-400 text-white hover:bg-blue-700 rounded-lg">Save</button>
                        </div>
                    </form>
                </div>
            </div>
